/*
    ...
    (But change the script src URL to wherever you have this widget stored on your site!)
        ...
        <div id="livro-de-visitas-form"></div>
        <script src="/comment-widget/livro-de-visitas.js"></script>
...
const s_loadingText = 'Carregando mensagens...';
...
document.getElementById('livro-de-visitas-form').innerHTML = v_mainHtml;
...
c_form.addEventListener('submit', function () {
    alert('Obrigado por assinar o meu livro de visitas! Sua mensagem foi enviada com sucesso e aparecerá em alguns segundos.');
    c_form.submit();
    return true;
});
