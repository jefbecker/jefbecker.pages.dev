/*
    ...
    (But change the script src URL to wherever you have this widget stored on your site!)
        ...
        <script src="/comment-widget/guestbook.js"></script>
...
const s_loadingText = 'Loading messages...';
...
document.getElementById('guestbook-form').innerHTML = v_mainHtml;
...
c_form.addEventListener('submit', function () {
    alert('Thank you for signing my guestbook! Your message was successfully sended and will appear in a few seconds.');
    c_form.submit();
    return true;
});
